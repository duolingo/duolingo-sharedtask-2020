...
python my_cands_extract.py --infile $OUTPUT/gen.out --outfile $OUTPUT/all_cands.txt --candlimit $CANDLIMIT
...
python staple_2020_scorer.py --gold ${DATA}/test-all-accepted.${src}-${tgt}.txt --pred ${OUTPUT}/all_cands_detok.txt
